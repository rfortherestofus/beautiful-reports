...
.alt-text-bottom-right[Alt text: Person pointing to their head and saying "DUH!"]
...
.alt-text-top-right[Alt text: Boss from Office Space]
...
.alt-text-bottom-right[Alt text: Person holding their head in their hands]
...
.alt-text-bottom-right[Alt text: Person with a confused look on their face]
...
.alt-text-top-right[Alt text: Beautiful lake with mountains surrounding it]
...
.alt-text-top-right[Alt text: Person standing on rock with arms outstretched]
